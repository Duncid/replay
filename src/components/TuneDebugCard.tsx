...
import type { TuneDebugData, NuggetPracticeHistory } from "@/types/tunePractice";
...
export function TuneDebugCard({ debugData, onProceed, onCancel }: TuneDebugCardProps) {
  ...
  return (
    <DebugCard title="Tune Coach Debug">
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            <div className="text-center p-2 bg-muted rounded">
              ...
              <div className="text-xs text-muted-foreground">Nuggets Practiced</div>
            </div>
            <div className="text-center p-2 bg-muted rounded">
        ...
        {debugData.practiceHistory.length > 0 && (
          <div>
                  ...
                  <div key={h.nuggetId} className="flex items-center justify-between text-xs bg-muted/50 p-1 rounded">
                    ...
                    <div className="flex gap-1">
                      <Badge variant="outline" className="text-xs">
                        {h.attemptCount} tries
                      </Badge>
                      <Badge variant={h.currentStreak > 0 ? "default" : "secondary"} className="text-xs">
                        🔥 {h.currentStreak}
                      </Badge>
                    </div>
                  </div>
